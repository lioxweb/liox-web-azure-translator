<?php
/**
 * Plugin Name: LioX Web Azure Translator for TranslatePress
 * Plugin URI: https://github.com/lioxweb/liox-web-azure-translator
 ...
 * Text Domain: liox-web-azure-translator-for-translatepress
...
define( 'LWX_AZURE_TRANSLATOR_VERSION', '1.1.3' );
...
function lwx_azure_add_engine( $engines ) {
    ...
    $by_value[ LWX_AZURE_ENGINE ] = array(
        ...
        'label' => __( 'Microsoft Azure Translator (LioX Web)', 'liox-web-azure-translator-for-translatepress' ),
    );
...
function lwx_azure_render_settings( $mt_settings ) {
        ...
        if ( is_object( $trp ) && method_exists( $trp, 'get_component' ) ) {
            ...
            if ( is_object( $translator ) && method_exists( $translator, 'check_api_key_validity' ) ) {
                ...
                if ( ! empty( $check['error'] ) ) {
                    $show_error    = true;
                    $error_message = ! empty( $check['message'] ) ? (string) $check['message'] : __( 'Azure Translator connection failed.', 'liox-web-azure-translator-for-translatepress' );
                }
            }
        }
    }
    ...
    <div class="trp-engine trp-automatic-translation-engine__container" id="<?php echo esc_attr( LWX_AZURE_ENGINE ); ?>">
        <span class="trp-primary-text-bold"><?php esc_html_e( 'Azure Translator API Key', 'liox-web-azure-translator-for-translatepress' ); ?></span>
        <div class="trp-automatic-translation-api-key-container">
            <input
                ...
                placeholder="<?php esc_attr_e( 'Paste Key 1 or Key 2 from Azure', 'liox-web-azure-translator-for-translatepress' ); ?>"
            />
            <?php
        ...
        <span class="trp-description-text">
            <?php esc_html_e( 'Use a key from Azure Portal -> Translator resource -> Keys and Endpoint.', 'liox-web-azure-translator-for-translatepress' ); ?>
        </span>

        <div class="trp-deepl-settings__container" style="margin-top:16px;">
            <span class="trp-primary-text-bold"><?php esc_html_e( 'Azure Region', 'liox-web-azure-translator-for-translatepress' ); ?></span>
            <input
                type="text"
            ...
            />
            <span class="trp-description-text">
                <?php esc_html_e( 'Required for regional or multi-service resources. Leave blank for a global single-service Translator resource.', 'liox-web-azure-translator-for-translatepress' ); ?>
            </span>
        </div>

        <div class="trp-deepl-settings__container" style="margin-top:16px;">
            <span class="trp-primary-text-bold"><?php esc_html_e( 'Azure Endpoint', 'liox-web-azure-translator-for-translatepress' ); ?></span>
            <input
                type="url"
                class="trp-text-input"
            ...
            />
            <span class="trp-description-text">
                <?php esc_html_e( 'Normally leave the default. Paste a custom Azure endpoint only if your resource requires one.', 'liox-web-azure-translator-for-translatepress' ); ?>
            </span>
        </div>

        <div class="trp-deepl-settings__container" style="margin-top:16px;">
            <span class="trp-primary-text-bold"><?php esc_html_e( 'Azure Target Languages (optional)', 'liox-web-azure-translator-for-translatepress' ); ?></span>
            <input
                type="text"
                class="trp-text-input"
            ...
            />
            <span class="trp-description-text">
                <?php esc_html_e( 'Comma-separated Azure language codes. Leave blank to allow every supported target language, including English. If you use a list and want new English strings translated too, include en. Example: en,fr,de,it,es,nl.', 'liox-web-azure-translator-for-translatepress' ); ?>
            </span>
        </div>

        <div class="trp-deepl-settings__container" style="margin-top:16px;">
            <span class="trp-primary-text-bold"><?php esc_html_e( 'Azure Monthly Hard Limit (characters)', 'liox-web-azure-translator-for-translatepress' ); ?></span>
            <input
                type="number"
                min="0"
                step="1000"
            ...
            />
            <span class="trp-description-text">
                <?php esc_html_e( 'LioX Web safety cap for Azure requests. Default: 1,900,000 characters per calendar month. Set 0 to disable this plugin-level cap.', 'liox-web-azure-translator-for-translatepress' ); ?>
            </span>
            <span class="trp-description-text" style="display:block;margin-top:6px;">
                <strong><?php esc_html_e( 'Current month:', 'liox-web-azure-translator-for-translatepress' ); ?></strong>
                <?php
                if ( 0 === $monthly_limit ) {
                    printf(
                        /* translators: %s: used character count. */
                        esc_html__( '%s characters tracked — hard limit disabled.', 'liox-web-azure-translator-for-translatepress' ),
                        esc_html( number_format_i18n( $monthly_used ) )
                    );
                } else {
                    printf(
                        /* translators: 1: used characters, 2: monthly limit, 3: remaining characters. */
                        esc_html__( '%1$s / %2$s used — %3$s remaining.', 'liox-web-azure-translator-for-translatepress' ),
                        esc_html( number_format_i18n( $monthly_used ) ),
            ...
            <span class="trp-description-text" style="display:block;margin-top:4px;">
                <?php esc_html_e( 'The local counter resets automatically when the UTC calendar month changes. It counts Azure translation requests sent by this WordPress installation, including explicit API credential tests.', 'liox-web-azure-translator-for-translatepress' ); ?>
            </span>
        </div>
    </div>
    <?php
...
function lwx_azure_dependency_notice() {
    ...
    <div class="notice notice-warning">
        <p>
            <strong><?php esc_html_e( 'LioX Web Azure Translator:', 'liox-web-azure-translator-for-translatepress' ); ?></strong>
            <?php esc_html_e( 'TranslatePress must be installed and active for this plugin to work.', 'liox-web-azure-translator-for-translatepress' ); ?>
        </p>
    </div>
    <?php
}
